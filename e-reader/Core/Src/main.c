...
int main(void)
{
  ...
  osThreadDef(logic_task, logic_task_fn, osPriorityAboveNormal, 0, 1024);
...
/**
* @brief Function implementing the displayer_task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_displayer_task_fn */
void displayer_task_fn(void const * argument)
{
  /* USER CODE BEGIN displayer_task_fn */
  ...
  /* USER CODE END displayer_task_fn */
}

/* USER CODE BEGIN Header_logic_task_fn */
/**
* @brief Function implementing the logic_task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_logic_task_fn */
void logic_task_fn(void const * argument)
{
  /* USER CODE BEGIN logic_task_fn */
